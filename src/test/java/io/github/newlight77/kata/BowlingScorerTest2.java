...
public class BowlingScorerTest2 {
    ...
    public void should_score_zero_when_having_frames_no_values() {
        ...
        // act
        int score = new BowlingScorer2(frames).score();
    ...
    @Test
    public void should_core_28_when_having_double_spares() {
        // arrange
    ...
    @Test
    public void should_core_28_when_having_triple_spares() {
        // arrange
